<div id="main">
	<div class="accounts view">
		...
		<dl>
			<?php
			$lists = array();
			$grav_url = 'http://www.gravatar.com/avatar.php?gravatar_id='.md5(strtolower($account['Account']['email'])).'&size=50';
			...
			if (Configure::read('Auth.id') === $account['Account']['id']) {
...
<div id="sidebar">
	<?php if (Configure::read('Auth.id') === $account['Account']['id']) :?>
	<div class="block">
